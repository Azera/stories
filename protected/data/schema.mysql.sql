...
-- Dumping data for table stories.user: ~3 rows (approximately)
...
INSERT INTO `user` (`id`, `username`, `email`, `status_id`, `salt`, `password`, `activkey`, `login_failures`, `locked_until`, `create_time`, `lastlogin_time`, `is_admin`) VALUES
	(1, 'admin', 'webmaster@example.com', 9, '', '21232f297a57a5a743894a0e4a801fc3', NULL, 0, NULL, '2012-05-21 10:36:16', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `story` (
  ...
  KEY `status_id` (`is_approved`),
  KEY `read_count` (`read_count`),
  KEY `reported_by_id` (`reported_user`),
  KEY `reviewed_by_id` (`reviewed_user`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table stories.story: ~4 rows (approximately)
/*!40000 ALTER TABLE `story` DISABLE KEYS */;
INSERT INTO `story` (`id`, `author_id`, `title`, `description`, `content`, `content_html`, `tags`, `is_approved`, `read_count`, `rating_count_1`, `rating_count_2`, `rating_count_3`, `rating_count_4`, `rating_count_5`, `reported_user`, `reported_time`, `reported_note`, `reviewed_user`, `reviewed_note`, `reviewed_time`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	(2, 1, 'Test Story', 'This is a test for new story creation', 'Once upon a time...\n\n...and they lived happily ever after', '', 'Mf reluc', 1, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2012-05-18 09:42:08', 1, '2012-05-18 09:42:08');
